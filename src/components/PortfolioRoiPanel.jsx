...
import { PieChart, BarChart, LineChart } from './charts/Charts';
...
import rc from '../pages/roiCalculator.module.css';

const LINE_COLORS = ['#00d2d3', '#58a6ff', '#3fb950', '#d29922', '#a371f7', '#f85149'];
const MONTH_LABELS = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];

/** Portfolio-level ROI model — used on Savings & ROI page and legacy /roi-calculator redirect. */
export default function PortfolioRoiPanel() {
  const { config } = usePm();
